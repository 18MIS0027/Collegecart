...
$sql=mysqli_query($con,"insert into products(coid,userphoneno,useremail,category,subCategory,productName,productCompany,productPrice,productDescription,shippingCharge,productAvailability,productImage1,productImage2,productImage3,productPriceBeforeDiscount) values('$coid','$userphoneno','$useremail','$category','$subcat','$productname','$productcompany','$productprice','$productdescription','$productscharge','$productavailability','$productimage1','$productimage2','$productimage3','$productpricebd')");
...
<br>
	<div class="form-group">
											<div class="controls">
												<center><button type="submit" name="submit" class="btn btn-primary">Next</button></center>
									</form>
							</div>
						</div>
						</div>
