...
//Application Title
define('APP_TITLE', 'Online File Manager');
...
$auth_users = array(
    'admin' => '$2y$10$z9m8JpoB6F7ISz9mxaI1P.8jCvHeSlZSQD6b5TKWT9a6ybSvbgXlK',
    'user' => '$2y$10$z9m8JpoB6F7ISz9mxaI1P.8jCvHeSlZSQD6b5TKWT9a6ybSvbgXlK' 
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash;
                            <a href="#" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Gunasekhar</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> Online File Manager <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Online File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="#" target="_blank" class="float-right text-muted">Online File Manager<?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
