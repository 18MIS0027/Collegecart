...
<br>
<div class="form-group">
												<center><button type="submit" name="submit" class="btn btn-primary" style="float:right;">Update</button></center>
	       <a href="manage-myproducts.php" class="btn btn-primary" style="float:left;">Back</a> 											
										</div>
									</form>
							</div>
						</div>
