...
<div class="container">
<?php
$ret=mysqli_query($con,"select * from products where subCategory='$cid' and coid='$college'");
...
<div class="col-md-4">
				...
				<img  src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="180" height="auto" alt=""></a></center>
								...
								<div class="panel-heading"><h4>Price:Rs <?php echo htmlentities($row['productPrice']);?></h4></div>	
																	<h2 class="btn btn-outline-success" style="float:left;"><a href="sub-category-login.php?pid=<?php echo htmlentities($row['id']);?>&&action=wishlist">Add to cart</a></h2>																	
																<h2 class="btn btn-outline-success" style="float:right;"><a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>">Product details</a></h2>		
<br>
<br>		
<br>																											
								</div>
